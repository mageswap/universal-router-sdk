...
import { MixedRouteTrade, MixedRouteSDK, Trade as RouterTrade } from '@mageswap/router-sdk'
import { Trade as V2Trade, Pair, Route as RouteV2, computePairAddress } from '@mageswap/v2-sdk'
import {
  Trade as V3Trade,
  Pool,
  Route as RouteV3,
...
import { CurrencyAmount, TradeType, Ether, Token, Percent, Currency } from '@mageswap/sdk-core'
